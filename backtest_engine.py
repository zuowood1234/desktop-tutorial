...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='AI Backtest Engine V1 (Tech Only)')
    ...
    if result:
        ...
        print("\n" + "="*40)
        print(f"💰 V1 回测结果 ({args.stock_code})")
        print(f"最终资产: {final:.2f}")
        print(f"收益率: {roi:.2f}%")
        print("="*40)
        
        filename = f"backtest_v1_{args.stock_code}.csv"
